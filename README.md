# demo_dbx
#TODO:: To be replaced by custom dbx installation document
...
```
This command will create your personal repository under `/Repos/<username>/src`.
...
- To trigger the release pipeline, get the current version from the `src/__init__.py` file and tag the current code version:
```
